...
YUI.add('moodle-theme_dynamicbase-bootstrap', function (Y, NAME) {

/**
The Moodle Bootstrap theme's bootstrap JavaScript

@namespace Moodle
@module theme_dynamicbase-bootstrap
**/

/**
The Moodle Bootstrap theme's bootstrap JavaScript

@class Moodle.theme_dynamicbase.bootstrap
@uses node
@uses selector-css3
@constructor
**/
var CSS = {
    ...
    SELECTORS = {
        ...
        NAV_COLLAPSE: '.nav-wrap'
    },
    NS = Y.namespace('Moodle.theme_dynamicbase.bootstrap');
