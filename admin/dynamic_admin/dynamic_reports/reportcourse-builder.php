...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="../_js/custom.course.js"></script>
...
<div class="links">
    <p><a href="<?php echo $CFG->wwwroot ?>">Moodle</a> &raquo; <a href="<?php echo $linkBackToReports ?>">Reports</a> &raquo; Store Training Records </p>
</div>
...
if (isadmin() || ismanager()) { ?>
	...
	<form action="<?php echo $CFG->wwwroot . "/admin/dynamic_admin/dynamic_reports/report.php?type=byCourse";  ?>" method="POST" id="styled-form">
