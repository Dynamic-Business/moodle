...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="../_js/custom.course-hr.js"></script>
...
<h2 class="report-header">Reports: HR Profile Data Report (Course Completions)</h2>
<div class="links">
    <p><a href="<?php echo $CFG->wwwroot ?>"><?php echo $SITE->fullname; ?></a> &raquo; <a href="<?php echo $linkBackToReports ?>">Reports</a> &raquo; HR Profile Data Report (Course Completions) </p>
</div>
...
if (isadmin()) { ?>
	...
	<!--<h3>Report by Profile Data</h3>-->
     ...
     <p class="description">Only shows available courses with Course Completion tracking enabled. Reports can take a long time to generate and therefore it is recommended that you use the filtering options where possible. </p>
     
	<form action="<?php echo $CFG->wwwroot . "/admin/dynamic_admin/dynamic_reports/report.php?type=byCourseHR";  ?>" method="POST" id="styled-form">
