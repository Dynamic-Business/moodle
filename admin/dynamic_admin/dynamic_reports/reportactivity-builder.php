...
if (isadmin() || ismanager()) { ?>
	...
	<?php }else{ ?>
		<form action="<?php echo $CFG->wwwroot . "/report/completion/index.php?gm=true"; ?>" method="POST" id="styled-form">
	<?php } ?>
    ...
    <div class="form-section-builder">
            <label>Course:</label><div class="checkbox-group-outer ajax-dd"><?php build_courses_dropdown(true,false,hasManagerCode());?></div>
            <!-- <label>Courses:</label> -->
			<?php
            // $iscoach = isCoach();
            // $manager = hasManagerCode();
           	// build_courses_dropdown(true,false,$manager);
            ?>
