...
<div class="links">
    <p><a href="<?php echo $CFG->wwwroot ?>">Moodle</a> &raquo; <a href="<?php echo $linkBackToEnrolments ?>">Group &amp; Enrolment Management</a> &raquo; Assign Group Manager "<?php echo $groupname; ?>"</p>
</div>
